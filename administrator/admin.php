    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <li class="nav-item navbar-nav ms-auto mb-2 mb-lg-0">
            <a class="btn btn-outline-light me-2" href="admin.php?url=user" role="button">Data User</a>
            <a class="btn btn-outline-light me-2" href="admin.php?url=data_barang" role="button">Data Barang</a>
            <a class="btn btn-outline-light me-2" href="admin.php?url=cetak" role="button">Cetak Laporan</a>
  ...
  <section class="p-4" id="main-content">
          <div class="card mt-5">
            ...
            <?php 
              $file = @$_GET['url'];
              if (empty($file)){
                echo"<h4>Anda Login Sebagai ADMINISTRATOR</h4>";
                  echo "<p>
